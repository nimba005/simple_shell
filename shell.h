...
int my_pipeline_handler(char *pipeline, char *envp[]);
...
void execute_commands(char *commands[], int num_commands, int pipefd[][2],
		char *envp[]);
void close_pipes(int pipesfd[][2], int num_pipes);
